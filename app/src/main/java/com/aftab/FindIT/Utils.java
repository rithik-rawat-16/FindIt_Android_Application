...
public final class Utils {
    ...
    private static String extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            JSONObject queryObject = baseJsonResponse.getJSONObject("query").getJSONObject("pages");
            String extractValue = queryObject.getJSONObject(queryObject.names().getString(0)).getString("extract");
